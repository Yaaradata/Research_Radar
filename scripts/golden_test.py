...
from research_radar.pipeline import bump, connect, load_orgs, load_people, process_item
...
def _run_golden(conn):
    if True:  # preserves existing indentation of the block below
        ...
        items = [
            {
                "source": "golden_test",
                "source_external_id": "arxiv:2608.02345",
                "source_feed": "golden",
                "source_type": "arxiv",
                "canonical_url": "https://arxiv.org/abs/2608.02345",
                "title": "arXiv:2608.02345",
                "summary": "AI agents experimentation",
                "authors_raw": [],
                "categories_raw": ["cs.AI"],
                "inoreader_tags": [],
                "raw_metadata": {},
                "published_at": None,
                "updated_at": None,
            ...
            {
                "source": "golden_test",
                "source_external_id": "unknown-org-paper",
                "source_feed": "golden",
                "source_type": "research_paper",
                "canonical_url": "https://example.org/research/unknown-org-ai-agents",
                "title": "Practical AI Agent Evaluation for Production Systems",
                "summary": "An empirical benchmark and evaluation framework for deploying tool-using AI agents in production engineering workflows.",
                "authors_raw": ["Researcher One"],
                "categories_raw": [],
                "inoreader_tags": [],
                "raw_metadata": {},
                "published_at": None,
        ...
        for r in rows:
            print(dict(r))
        assert any(
            r["canonical_name"] == "Amazon" and r["evidence_type"] == "email_domain" for r in rows
        ), "Golden #1: Amazon email-domain evidence not resolved"
        unknown = [r for r in rows if r["title"] == items[1]["title"]]
        assert unknown and max(float(r["notable_org_signal"] or 0) for r in unknown) == 0, (
            "Golden #2: unknown org incorrectly boosted"
        )
        print(
